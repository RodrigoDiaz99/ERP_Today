        ...
        <div x-data="{ recovery: false }">
            ...
            <form method="POST" action="/two-factor-challenge">
                ...
                <div class="mt-4" x-show="! recovery">
                    <x-label value="Code"/>
                    <x-input class="block mt-1 w-full" type="text" name="code" autofocus x-ref="code"
                             autocomplete="one-time-code"/>
                </div>

                <div class="mt-4" x-show="recovery">
                    <x-label value="Recovery Code"/>
                    <x-input class="block mt-1 w-full" type="text" name="recovery_code" x-ref="recovery_code"
                             autocomplete="one-time-code"/>
                </div>
